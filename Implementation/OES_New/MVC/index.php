...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="name" name="email" placeholder="Enter your email" class="form-control input-md" type="text">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="name" name="password" placeholder="Enter your password" class="form-control input-md" type="password">
...
<!-- sign in form begins -->  
  <form class="form-horizontal" name="form" action="controller/Register_controller.php" onSubmit="return validateForm()" method="POST">
<fieldset>
...
<div class="form-group">
  <label class="col-md-12 control-label" for="name"></label>  
  <div class="col-md-12">
  <input id="college" name="collage" placeholder="Enter your college name" class="form-control input-md" type="text">
...
<div class="form-group">
  ...
  <div class="col-md-12"> 
    <input  type="submit" class="sub" name="signup" value="Signup" class="btn btn-primary"/>
  </div>
</div>
